...
| **7** | **الورديات وإغلاق الشيفت (Shifts & Z-Report)** | نموذج `ClosedShift.php` (`closed_orders`)، خدمة حساب مبيعات الشيفت، تسجيل العجز والزيادة، وتوليد تقرير Z. | ⏳ **قيد التنفيذ** |
| **8** | **الموارد البشرية والرواتب (HR & Payroll)** | الموظفين، الحضور والانصراف، البصمة، احتساب مسير الرواتب والخصومات والبدلات. | 📋 **مجدول** |
| **9** | **التقارير المالية والتحليلات (Reports & General Ledger)** | كشف الحساب، ميزان المراجعة، الأرباح والخسائر، تقارير حركة المبيعات والمخزون الراكد. | 📋 **مجدول** |
